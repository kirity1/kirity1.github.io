...
#### shift k s 를 동시에 눌러보면<img src="https://raw.githubusercontent.com/kirity1/blogimg/master/uPic/image-20240410180808929.png" alt="image-20240410180808929" style="zoom:67%;" />
...
안타깝게도 find with Selection 이라는 유용한 명령어가 이미 바인딩 돼있었다, 그래서 다른 키를 찾아보고 있는중이다, 참고로 이 명령어는 현재 파일에 내가 선택한 단어와 똑같은 단어 모두를 일괄적으로 바꾸는거다. 아무튼 이렇게 잘 찾아보자
